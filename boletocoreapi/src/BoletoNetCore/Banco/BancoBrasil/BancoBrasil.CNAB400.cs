...
{
    internal partial class BancoBrasil : IBancoCNAB400
    {
        public string GerarDetalheRemessaCNAB400(Boleto.Boleto boleto, ref int numeroRegistro)
        {
            try
            {
                // Registro 7 - Obrigatório
                var detalhe = GerarDetalheRemessaCNAB400Registro7(boleto, ref numeroRegistro);
        ...
        public string GerarHeaderRemessaCNAB400(ref int numeroArquivoRemessa, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0032, 008, 0, Beneficiario.ContaBancaria.Conta,
                    '0');
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0040, 001, 0,
        ...
        private string GerarDetalheRemessaCNAB400Registro7(Boleto.Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                numeroRegistroGeral++;
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0392, 002, 0,
                    boleto.CodigoProtesto == TipoCodigoProtesto.ProtestarDiasCorridos
                        ? boleto.DiasProtesto.ToString("00")
                        : string.Empty, ' ');
        ...
        private string GerarDetalheRemessaCNAB400Registro5Multa(Boleto.Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliDireita______, 0023, 003, 0,
                    boleto.DiasLimiteRecebimento.HasValue
                        ? boleto.DiasLimiteRecebimento.Value.ToString("000")
                        : string.Empty, ' ');
