...
{
    internal partial class BancoCecred : IBancoCNAB240
    {
        public string GerarHeaderRemessaCNAB240(ref int numeroArquivoRemessa, ref int numeroRegistro)
        {
            try
            {
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 18, 1, 0, Beneficiario.TipoCPFCNPJ("0"),
                    '0');
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 53, 5, 0,
                    Beneficiario.ContaBancaria.Agencia, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 58, 1, 0,
                    Beneficiario.ContaBancaria.DigitoAgencia, ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 59, 12, 0,
                    Beneficiario.ContaBancaria.Conta, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 71, 1, 0,
        ...
        public string GerarHeaderLoteRemessaCNAB240(ref int numeroArquivoRemessa, ref int numeroRegistro)
        {
            try
            {
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 54, 5, 0,
                    Beneficiario.ContaBancaria.Agencia, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 59, 1, 0,
                    Beneficiario.ContaBancaria.DigitoAgencia, ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 60, 12, 0,
                    Beneficiario.ContaBancaria.Conta, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 72, 1, 0,
                    Beneficiario.ContaBancaria.DigitoConta, ' ');
            ...
            int numeroRegistroCobrancaDescontada, decimal valorCobrancaDescontada)
        {
            try
            {
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 24, 6, 0, numeroRegistroCobrancaSimples,
                    '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 30, 17, 2, valorCobrancaSimples, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 47, 6, 0,
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 70, 6, 0,
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 93, 6, 0,
        ...
        public string GerarDetalheRemessaCNAB240(Boleto.Boleto boleto, ref int numeroRegistro)
        {
            var str1 = GerarDetalheSegmentoPRemessaCNAB240(boleto, ref numeroRegistro) + Environment.NewLine +
                       GerarDetalheSegmentoQRemessaCNAB240(boleto, ref numeroRegistro);
            var str2 = GerarDetalheSegmentoRRemessaCNAB240(boleto, ref numeroRegistro);
            if (!IsNullOrWhiteSpace(str2))
                str1 = str1 + Environment.NewLine + str2;
            var str3 = GerarDetalheSegmentoSRemessaCNAB240(boleto, ref numeroRegistro);
        ...
        public override void LerHeaderRetornoCNAB240(ArquivoRetorno arquivoRetorno, string registro)
        {
            ...
            arquivoRetorno.Banco.Beneficiario.CPFCNPJ = registro.Substring(17, 1) == "1"
                ? registro.Substring(21, 11)
                : registro.Substring(18, 14);
            ...
            arquivoRetorno.DataGeracao =
                Utils.ToDateTime(Utils.ToInt32(registro.Substring(143, 8)).ToString("##-##-####"));
        ...
        public override void LerDetalheRetornoCNAB240SegmentoT(ref Boleto.Boleto boleto, string registro)
        {
            try
            {
                ...
                boleto.DataVencimento =
                    Utils.ToDateTime(Utils.ToInt32(registro.Substring(73, 8)).ToString("##-##-####"));
                ...
                var str = registro.Substring(133, 15);
        ...
        public override void LerDetalheRetornoCNAB240SegmentoU(ref Boleto.Boleto boleto, string registro)
        {
            try
            {
                ...
                boleto.DataProcessamento =
                    Utils.ToDateTime(Utils.ToInt32(registro.Substring(137, 8)).ToString("##-##-####"));
        ...
        private string GerarDetalheSegmentoPRemessaCNAB240(Boleto.Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ++numeroRegistroGeral;
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 16, 2, 0, boleto.CodigoMovimentoRetorno,
                    '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 18, 5, 0,
                    boleto.Banco.Beneficiario.ContaBancaria.Agencia, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 23, 1, 0,
                    boleto.Banco.Beneficiario.ContaBancaria.DigitoAgencia, ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 24, 12, 0,
                    boleto.Banco.Beneficiario.ContaBancaria.Conta, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 36, 1, 0,
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 37, 17, 0,
                    Utils.FormatCode(boleto.NossoNumero, 17), '0');
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 61, 1, 0,
                    (int) boleto.Banco.Beneficiario.ContaBancaria.TipoImpressaoBoleto, '0');
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 107, 2, 0, (int) boleto.EspecieDocumento,
                    '0');
                ...
                else
                {
                    ...
                    tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, sbyte.MaxValue, 15, 2,
                ...
                else
                {
                    ...
                    tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 151, 15, 2, boleto.ValorDesconto,
                        '0');
                }
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 196, 25, 0,
        ...
        private string GerarDetalheSegmentoQRemessaCNAB240(Boleto.Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ++numeroRegistroGeral;
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 16, 2, 0, boleto.CodigoMovimentoRetorno,
                    '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 18, 1, 0,
                    boleto.Pagador.TipoCPFCNPJ("0"), '0');
                ...
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 74, 40, 0,
                    boleto.Pagador.Endereco.FormataLogradouro(40), ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 114, 15, 0,
                    boleto.Pagador.Endereco.Bairro, ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 129, 8, 0,
                    boleto.Pagador.Endereco.CEP.Replace("-", ""), ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 137, 15, 0,
                    boleto.Pagador.Endereco.Cidade, ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 152, 2, 0, boleto.Pagador.Endereco.UF,
                    ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 154, 1, 0,
                    boleto.Avalista.TipoCPFCNPJ("0"), '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 155, 15, 0, boleto.Avalista.CPFCNPJ,
                    '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 170, 40, 0, boleto.Avalista.Nome, ' ');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 210, 3, 0,
                    boleto.Banco.Beneficiario.ContaBancaria.CodigoBancoCorrespondente, '0');
                tregistroEdi.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 213, 20, 0,
                    boleto.Banco.Beneficiario.ContaBancaria.NossoNumeroBancoCorrespondente, ' ');
        ...
        private string GerarDetalheSegmentoRRemessaCNAB240(Boleto.Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                var str = "0";
        ...
        private string GerarDetalheSegmentoSRemessaCNAB240(Boleto.Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                var str = boleto.MensagemArquivoRemessa.PadRight(500, ' ').Substring(0, 200).FitStringLength(200, ' ');
