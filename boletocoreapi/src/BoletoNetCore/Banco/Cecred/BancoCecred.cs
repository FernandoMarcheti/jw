...
namespace BoletoNetCore.Banco.Cecred
{
    internal sealed partial class BancoCecred : BancoFebraban<BancoCecred>, IBanco
    {
        ...
        {
            return
                $"CB{DateTime.Now.Date.Day:00}{DateTime.Now.Date.Month:00}{numeroSequencial.ToString().PadLeft(9, '0').PadRight(2)}.rem";
        }
        ...
        public void FormataBeneficiario()
        {
            ...
            Beneficiario.CodigoFormatado = contaBancaria.Agencia + "-" + contaBancaria.DigitoAgencia + "    " +
