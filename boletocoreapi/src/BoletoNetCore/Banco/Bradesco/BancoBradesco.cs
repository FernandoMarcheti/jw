...
namespace BoletoNetCore.Banco.Bradesco
{
    internal sealed partial class BancoBradesco : BancoFebraban<BancoBradesco>, IBanco
    {
        ...
        public void FormataBeneficiario()
        {
            ...
            Beneficiario.Codigo = codigoBeneficiario.Length <= 20
                ? codigoBeneficiario.PadLeft(20, '0')
                : throw BoletoNetCoreException.CodigoBeneficiarioInvalido(codigoBeneficiario, 20);
