...
namespace BoletoNetCore.Banco
{
    partial class BancoFebraban<T>
    {
        ...
        public virtual void LerDetalheRetornoCNAB240SegmentoT(ref Boleto.Boleto boleto, string registro)
        {
            try
            {
                ...
                var tmp = registro.Substring(37, 20);
        ...
        public virtual void LerDetalheRetornoCNAB240SegmentoU(ref Boleto.Boleto boleto, string registro)
        {
            try
            {
                //Valor do Título
        ...
        public virtual void LerDetalheRetornoCNAB240SegmentoA(ref Boleto.Boleto boleto, string registro)
        {
        }
    }
}