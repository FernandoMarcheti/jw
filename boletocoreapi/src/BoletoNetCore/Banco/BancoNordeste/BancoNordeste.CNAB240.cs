...
{
    internal partial class BancoNordeste : IBancoCNAB240
    {
        public string GerarHeaderRemessaCNAB240(ref int numeroArquivoRemessa, ref int numeroRegistro)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0058, 001, 0,
                    Beneficiario.ContaBancaria.DigitoAgencia, '0');
        ...
        public string GerarHeaderLoteRemessaCNAB240(ref int numeroArquivoRemessa, ref int numeroRegistro)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0143, 030, 0,
                    Beneficiario.Endereco.LogradouroEndereco, ' ');
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0173, 005, 0,
                    Beneficiario.Endereco.LogradouroNumero, '0');
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0178, 015, 0,
                    Beneficiario.Endereco.LogradouroComplemento, ' ');
        ...
        private string GerarDetalheSegmentoARemessaCNAB240(Boleto.Boleto boleto, ref int registro)
        {
            var reg = new TRegistroEDI();
            ...
            reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0029, 001, 0, boleto.DigitoVerificadorAgenciaDebitada,
                '0');
            reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0030, 012, 0, boleto.ContaDebitada, '0');
            reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0042, 001, 0,
                boleto.DigitoVerificadorAgenciaContaDebitada, '0');
            reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0043, 001, 0,
                boleto.DigitoVerificadorAgenciaContaDebitada, '0'); // Dac ????
